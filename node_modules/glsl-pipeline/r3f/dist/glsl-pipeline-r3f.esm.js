...
import { G as GlslPipeline } from '../../dist/vanilla-d3c2784c.esm.js';
import { create } from 'zustand';
import { i as isPerspectiveCamera } from '../../dist/ts-main-dd88c709.esm.js';
import 'three';
...
var GlslPipelineContext = create(function () {
  return {};
});
...
var GlslPipelineReact = /* @__PURE__ */React.memo(/*#__PURE__*/React.forwardRef(function (_ref, ref) {
  ...
  var addCallback = React.useCallback(function (callback, priority, pipeline) {
  ...
  var removeCallback = React.useCallback(function (callback) {
    callbacks.current = callbacks.current.filter(function (cb) {
      return cb.callback !== callback;
    });
  }, []);
  var filtered = React.useCallback(function (pipe) {
  ...
  var onRender = React.useCallback(function (s) {
  ...
  var pipeline = React.useMemo(function () {
    ...
    if (ref && ref.current instanceof GlslPipeline) {
  ...
  return /*#__PURE__*/React.createElement(React.Fragment, null, type === 'scene' ? /*#__PURE__*/React.createElement("primitive", {
    ref: ref,
    attach: "material",
    object: material
  }) : type === 'main' && /*#__PURE__*/React.createElement("mesh", null, /*#__PURE__*/React.createElement("planeGeometry", {
    args: [2, 2]
...
export { GlslPipelineContext, GlslPipelineReact, useGlslPipeline };
